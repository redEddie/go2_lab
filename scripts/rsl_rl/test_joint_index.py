"""
python scripts/rsl_rl/test_joint_index.py --task=Template-Isaac-Velocity-Flat-Go2-Play-v0 --joint=1
"""
...
# Stand up and down positions (can be adjusted)
...
actions_buf[int(args_cli.joint)] = -0.5
...
def main():
    ...
    # reset environment
    amplitude = 2  # or any suitable value for your joint
    frequency = 1.0  # Hz, adjust as needed
    timestep = 0
    dt = 0.005
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            actions = policy(obs)
            t = timestep * dt
            actions[:, args_cli.joint] = stand_up_joint_pos[args_cli.joint] + amplitude * np.sin(2 * np.pi * frequency * t)
            # env stepping
